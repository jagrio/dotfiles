...
sed -i '/$user Dotfiles/d' ~/.bashrc

echo "     Adding a new instance for exporting DOTFILES_DIR var"
echo "DOTFILES_DIR=$DOTFILES_DIR # $user Dotfiles" >> ~/.bashrc
echo "" >> ~/.bashrc

echo "     Adding a new instance for sourcing mybashrc"
echo "" >> ~/.bashrc
echo "# $user Dotfiles: Source mybashrc" >> ~/.bashrc
echo "if [ -f $DOTFILES_DIR/bash/mybashrc ]; then # $user Dotfiles" >> ~/.bashrc
echo "    . $DOTFILES_DIR/bash/mybashrc # $user Dotfiles" >> ~/.bashrc
echo "fi # $user Dotfiles" >> ~/.bashrc
echo "" >> ~/.bashrc
