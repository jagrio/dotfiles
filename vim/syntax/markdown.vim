...
syn region markdownMath start="\S\@<=\$\|\$\S\@=" end="\S\@<=\$\|\$\S\@=" keepend contains=markdownLineStart
syn region markdownMath2 start="\S\@<=\$\$\|\$\$\S\@=" end="\S\@<=\$\$\|\$\$\S\@=" keepend contains=markdownLineStart,markdownMath
syn region markdownMath2 start="^\s*$$.*$" end="^\s*$$\ze\s*$" keepend
